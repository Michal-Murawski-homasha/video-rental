...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Wypożyczalnia wideo</div>
    </a>
    ...
    <!-- Nav Item - Loan history -->
    <li class="nav-item">
        <a class="nav-link" href="renatal-history.php">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
            ...
            <span>Historia wypożyczeń</span></a>
    </li>

    <!-- Nav Item - Employee card -->
    <li class="nav-item">
        <a class="nav-link" href="employee-card.php">
